...
func TestReflectorWatchHandlerError(t *testing.T) {
	...
	_, err := watchHandler(time.Now(), fw, s, g.expectedType, g.expectedGVK, g.name, g.expectedTypeName, g.setLastSyncResourceVersion, g.clock, false, nevererrc, wait.NeverStop)
	if err == nil {
...
func TestReflectorStopWatch(t *testing.T) {
	...
	stopWatch <- struct{}{}
	_, err := watchHandler(time.Now(), fw, s, g.expectedType, g.expectedGVK, g.name, g.expectedTypeName, g.setLastSyncResourceVersion, g.clock, false, nevererrc, stopWatch)
